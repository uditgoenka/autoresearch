...
1. Read the autonomous loop protocol: `.opencode/skills/autoresearch/references/autonomous-loop-protocol.md`
2. Read the results logging format: `.opencode/skills/autoresearch/references/results-logging.md`
3. If Goal, Scope, Metric, and Verify are all extracted — proceed directly to loop setup
4. If any critical field is missing — use `question` with batched questions as defined in SKILL.md "Interactive Setup" section
